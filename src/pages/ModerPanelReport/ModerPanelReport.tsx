                ...
                {reports.map((report, index) => (
                  <Fragment key={report._id}>
                    <tr
                      ...
                      onClick={() =>
                        setOpenReportId(
                          openReportId === report._id ? null : report._id
                        )
                      }
                    >
                      ...
                      <td>
                        {new Date(report.dateUpload).toLocaleDateString()}
                      </td>
                      <td>{report.type}</td>
                    </tr>
                          ...
                          style={{
                            maxHeight:
                              openReportId === report._id
                                ? heights[report._id] || 0
                                : 0,
                          }}
                        >
                          <div
                            ref={(el: any) =>
                              (contentRefs.current[report._id] = el)
                            }
                            ...
                            <div className="d-flex gap-3 flex-wrap">
                              {report.type !== "checked" && (
                                <button
                                  ...
                                  onClick={() => checkReport(report._id)}
                                >
                                  Check
                                </button>
                              )}
